...
const Checklist = () => {
	return (
		<div>
			<div>
				<h4>
					<HashLink to='#customCheck' className='jumpLink'>
						Jump to Customizable Checklist
					</HashLink>
				</h4>
			</div>
			<h1 style={{ padding: '1rem 0' }}>Self-Publishing Checklist</h1>
			<p>
				Have you done all you can to ensure that your book is a
				success?
			</p>
